...
class Manufacturer(models.Model):
    ...
    website = models.URLField \
        (help_text="The Manufacturer's website.")
    email = models.EmailField \
        (help_text="The Manufacturer's email address.")
...
class Importer(models.Model):
    ...
    first_names = models.CharField \
        (max_length=50, \
         help_text= \
             "The importer's first name or names.")
    last_names = models.CharField \
        (max_length=50, \
         help_text= \
             "The importer's last name or names.")
    email = models.EmailField \
        (help_text= \
             "The contact email for the importer.")
...
class Car(models.Model):
    name = models.CharField \
        (max_length=70, \
         help_text="The title of the car.")
    manufacture_date = models.DateField \
        (verbose_name= \
             "Date the car was manufactured.")
...
class CarImporter(models.Model):
    ...
    role = models.CharField \
        (verbose_name= \
             "The role this importer had in the car.", \
         choices=ImportationRole.choices, max_length=20)
...
class Review(models.Model):
    ...
    car = models.ForeignKey \
        (Car, on_delete=models.CASCADE, \
         help_text="The Car that this review is for.")
